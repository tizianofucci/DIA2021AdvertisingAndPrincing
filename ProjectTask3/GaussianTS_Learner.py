...
class GaussianTS_Learner(Learner):
    ...
    def update(self, pulled_arm, reward):        
        ...
        self.means_of_rewards[pulled_arm] = ((self.precision_of_rewards[pulled_arm] * self.means_of_rewards[pulled_arm]) + (len(self.rewards_per_arm[pulled_arm]) * np.mean(self.rewards_per_arm[pulled_arm])))/(self.precision_of_rewards[pulled_arm] + len(self.rewards_per_arm[pulled_arm]))
        ...
        self.precision_of_rewards[pulled_arm] += 0.05