...
class ContextEnvironment():
    ...
    def round(self,after_30_days_arm_ts,bid):
        ...
        rewards[0]= self.environments[0].round([after_30_days_arm_ts[0], after_30_days_arm_ts[0], after_30_days_arm_ts[0], after_30_days_arm_ts[0]],bid)
        rewards[1]= self.environments[1].round([after_30_days_arm_ts[1], after_30_days_arm_ts[1], after_30_days_arm_ts[2], after_30_days_arm_ts[2]],bid)
        rewards[2]= self.environments[2].round([after_30_days_arm_ts[3], after_30_days_arm_ts[4], after_30_days_arm_ts[3], after_30_days_arm_ts[4]],bid)
        rewards[3]= self.environments[3].round([after_30_days_arm_ts[5], after_30_days_arm_ts[6], after_30_days_arm_ts[7], after_30_days_arm_ts[8]],bid)
